...
Vertical:
- starlight-agent-skills v0.1.0 · portable capability layer · 22 skills across 6
  domains (cosmos, research, media, education, coding, brand); rich-portable skill
  contract (SKILL.md + manifest.json + examples/ + tests/); runtime adapters for
  Claude, Codex, Cursor, Gemini, OpenCode, and SIS; `skill-rules.json`
  auto-activation; `port-skill.mjs` sync into SIS/ACOS.
